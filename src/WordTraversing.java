...
public class WordTraversing {
    ...
    //one letter at a time, and where each intermediate step needs to be a real word
    //i.e. damp --> lamp --> lame --> lime --> like
    public static Set<String> dictionary;
    public static void main(String[] args) {
        setupDictionary();
//        runBFSTests();
//        runDFSTests();
//        runLessGreedyDFSTests();
        runGreedyDFSTests();
//        runGreedierDFSTests();
    }

    private static void runBFSTests() {
    ...
    private static void runDFSTests() {
    ...
    private static void runLessGreedyDFSTests() {
        System.out.println("Less Greedy DFS:");
        long start = System.currentTimeMillis();
        lessGreedyDFS("damp", "like");
        System.out.println("\t" + (System.currentTimeMillis()-start) + " ms");
        start = System.currentTimeMillis();
        lessGreedyDFS("damp", "dank");
        System.out.println("\t" + (System.currentTimeMillis()-start) + " ms");
        start = System.currentTimeMillis();
        lessGreedyDFS("hole", "mark");
        System.out.println("\t" + (System.currentTimeMillis()-start) + " ms");
        start = System.currentTimeMillis();
        lessGreedyDFS("beta", "zeta");
        System.out.println("\t" + (System.currentTimeMillis()-start) + " ms");
        System.out.println("------------------------------------------------------");
    }
    private static void runGreedyDFSTests() {
        System.out.println("Greedy DFS:");
        long start = System.currentTimeMillis();
        greedyDFS("damp", "like");
        System.out.println("\t" + (System.currentTimeMillis()-start) + " ms");
        start = System.currentTimeMillis();
    ...
    private static void runGreedierDFSTests() {
        System.out.println("Greedier DFS:");
        long start = System.currentTimeMillis();
        greedierDFS("damp", "like");
        System.out.println("\t" + (System.currentTimeMillis()-start) + " ms");
        start = System.currentTimeMillis();
        greedierDFS("damp", "dank");
        System.out.println("\t" + (System.currentTimeMillis()-start) + " ms");
        start = System.currentTimeMillis();
        greedierDFS("hole", "mark");
        System.out.println("\t" + (System.currentTimeMillis()-start) + " ms");
        start = System.currentTimeMillis();
        greedierDFS("beta", "zeta");
        System.out.println("\t" + (System.currentTimeMillis()-start) + " ms");
        System.out.println("------------------------------------------------------");
    }
    ...
    private static void greedyDFS(String start, String end) {
        ...
        while (!fringe.isEmpty() && !found) {
            ...
            seen.add(curr);
            List<String> next = getNextWords(curr);
            List<Integer> inCommon = new ArrayList<>(next.size());
            int maxInCommon = -1;
            for (int i = 0; i < next.size(); i++) {
                ...
                int nInCommon = seen.contains(s) ? -1 : lettersInCommon(s, end);
                inCommon.add(nInCommon);
                if (nInCommon > maxInCommon) {
                    maxInCommon = nInCommon;
                }
            }
            if (!found) {
                for (int i = 0; i < next.size(); i++) {
                    if (inCommon.get(i) != -1 && inCommon.get(i) != maxInCommon) {
                        String s = next.get(i);
                        cameFrom.put(s, curr);
                        fringe.push(s);
                    }
...
//
//
//                if (!seen.contains(s) && lettersInCommon(s, end) > lettersInCommon(curr, end)) {
//                    fringe.push(s);
//                    cameFrom.put(s, curr);
//                    if (s.equals(end)) {
//                        found = true;
...
//            }
    ...
    private static void lessGreedyDFS(String start, String end) {
        Stack<String> fringe = new Stack<>();
        Set<String> seen = new HashSet<>();
        Map<String, String> cameFrom = new HashMap<>();
        cameFrom.put(start, null);
    ...
    private static int lettersInCommon(String word1, String word2) {
        int counter = 0;
